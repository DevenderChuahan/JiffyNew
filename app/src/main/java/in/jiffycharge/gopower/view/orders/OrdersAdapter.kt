...
class OrdersAdapter(val context: Context, val list: Order_list_model) :RecyclerView.Adapter<OrdersAdapter.Myviewholder>(){
...
//    }
    ...
    override fun onBindViewHolder(holder:Myviewholder, position: Int) {
        ...
        holder.bindItems(list.content.get(position))
